                                ...
                                <form action="MainController" method="post">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="checkIn" class="form-control" value="${sessionScope.CHECKIN_DATE}"  readonly=""/>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label">Check Out</label>
                                            <input type="date" name="checkOut" class="form-control" value="${sessionScope.CHECKOUT_DATE}" readonly=""/>
                                        </div>
                                        <div class="form-group">
